// Floating WhatsApp CTA — shown on all pages, bottom-right.
    ...
    <a
      ...
      onMouseEnter={(e) => {
        ...
        (e.currentTarget as HTMLAnchorElement).style.boxShadow =
          "0 6px 28px rgba(37,211,102,0.6), 0 3px 12px rgba(0,0,0,0.2)";
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <span
        ...
        style={{
          ...
          animation: "whatsappPing 2s ease-in-out infinite",
        }}
      />
      <style>{`
