...
-- Allow authenticated users (you, via AI Studio) to insert/update/delete
-- Since you are using same supabase project, you can manage this via the dashboard or your admin app
